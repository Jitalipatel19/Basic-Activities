...
public class Seekbar_Discrete_Example extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
   SeekBar sbar;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.seekbar_discrete_example);
    ...
    public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
        Toast.makeText(getApplicationContext(), "Seekbar progeres"+i, Toast.LENGTH_SHORT).show();
    }
