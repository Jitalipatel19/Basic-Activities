...
public class Context_Menu_Example extends AppCompatActivity  {
   ...
   String name[]={"JITALI","RIDDHI","ABHILASHA","SEJAL","DIVYANSHI"};
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
       // return super.onContextItemSelected(item);
        ...
        {
            for(int i=0;i<lview1.getCount();i++)
            {
                if(i==((int)info.id))
                {
                    lview1.getChildAt(i).setBackgroundColor(Color.RED);
                }else{
                    lview1.getChildAt(i).setBackgroundColor(Color.WHITE);
                }
            }
        }
        else if(item.getTitle()=="GREEN")
        {
            for(int i=0;i<lview1.getCount();i++)
            {
                if(i==((int)info.id))
                {
                    lview1.getChildAt(i).setBackgroundColor(Color.GREEN);
                }else{
                    lview1.getChildAt(i).setBackgroundColor(Color.WHITE);
                }
            }
            ...
            for(int i=0;i<lview1.getCount();i++)
            {
                if(i==((int)info.id))
                {
                    lview1.getChildAt(i).setBackgroundColor(Color.BLUE);
                }else{
                    lview1.getChildAt(i).setBackgroundColor(Color.WHITE);
                }
            }
