...
public class TextToSpeech_Example extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    EditText edttext;
    Button btnspeech;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.texttospeech_example);
