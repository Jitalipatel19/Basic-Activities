...
public class Switch_Example extends AppCompatActivity {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b)
                {
                 ...
                 swt5.setChecked(false);
                    ...
                    if(!(swt2.isChecked() || swt3.isChecked() || swt4.isChecked() || swt5.isChecked()))
                    {
        ...
        swt2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b)
                {
                    ...
                    if(!(swt1.isChecked() || swt3.isChecked() || swt4.isChecked() || swt5.isChecked()))
                    {
                        clayout.setBackgroundColor(Color.WHITE);
                    }
                }
        ...
        swt3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b)
                {
                    ...
                    if(!(swt2.isChecked() || swt1.isChecked() || swt4.isChecked() || swt5.isChecked()))
                    {
                        clayout.setBackgroundColor(Color.WHITE);
                    }
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b)
                {
                   clayout.setBackgroundColor(Color.MAGENTA);
                    ...
                    if(!(swt2.isChecked() || swt3.isChecked() || swt5.isChecked() || swt1.isChecked()))
                    {
                        clayout.setBackgroundColor(Color.WHITE);
                    }
                }
        ...
        swt5.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b)
                {
                    ...
                    if(!(swt1.isChecked() || swt2.isChecked() || swt3.isChecked() || swt4.isChecked())){
                        clayout.setBackgroundColor(Color.WHITE);
                    }
                }
            }
