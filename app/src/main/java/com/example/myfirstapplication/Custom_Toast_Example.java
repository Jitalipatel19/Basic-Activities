...
public class Custom_Toast_Example extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.custom_toast_example);
        LayoutInflater li=getLayoutInflater();
        View v=li.inflate(R.layout.customtoast,(ViewGroup) findViewById(R.layout.custom_toast_example));
